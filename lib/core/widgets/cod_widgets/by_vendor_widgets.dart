                ...
                children: [
                  for (int i = 0; i < codSettlementController.vendorNameList[0]["data"].length; i++)
                    CommonCodVendorsCard(
                      ...
                      collectedAmount: "₹ " + num.parse(codSettlementController.vendorNameList[0]["data"][i]["mainBalance"].toString()).abs().toString(),
                  ...
                  for (int i = 0; i < codSettlementController.vendorList.length; i++)
                    Container(
                      ...
                      child: CommonCodVendorDataCard(
                        ...
                        name: codSettlementController.vendorList[i]["orderDetails"]["vendorOrderStatusId"]["addressId"]["name"].toString().toCapitalized(),
                        personName: "(${codSettlementController.vendorList[i]["orderDetails"]["vendorOrderStatusId"]["addressId"]["person"].toString().toCapitalized()})",
                        ...
                        codAmount: codSettlementController.vendorList[i]["orderDetails"]["collectableCash"] != null ? "₹" + codSettlementController.vendorList[i]["orderDetails"]["collectableCash"].toString() : "₹0",
                        cashReceive: codSettlementController.vendorList[i]["orderDetails"]["cashReceive"] != null ? "₹" + codSettlementController.vendorList[i]["orderDetails"]["cashReceive"].toString() : "₹0",
                        diffAmount: codSettlementController.vendorList[i]["orderDetails"]["deferenceAmount"] != null ? "₹" + codSettlementController.vendorList[i]["orderDetails"]["deferenceAmount"].toString() : "₹0",
